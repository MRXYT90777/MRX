...
bot = telebot.TeleBot('7481403036:AAGsCJ4ULQvy47C-EPjIuCuuATcIQH73EKg')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @MRXYTDM."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @MRXYTDM ."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f" 🚀 ATTACK SENT SUCCESSFULLY 🚀 : {target}:{port} for {time}\nSEC "
    bot.reply_to(message, response)
